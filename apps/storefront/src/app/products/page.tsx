...
function ProductsContent() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const matchesCategory = !selectedCategory; // Temporarily disable category filter due to API structure
    // TODO: Implement category filtering once API is updated
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="space-y-10 sticky top-8">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-luxury-sand bg-white text-luxury-charcoal placeholder-luxury-brown/50 focus:outline-none focus:border-luxury-gold focus:ring-1 focus:ring-luxury-gold transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border border-luxury-sand bg-white text-luxury-charcoal focus:outline-none focus:border-luxury-gold focus:ring-1 focus:ring-luxury-gold transition-colors"
                >
              ...
              {(searchTerm || selectedCategory || minPrice > 0 || maxPrice < 10000) && (
                <button
                  ...
                  className="w-full px-5 py-3 text-sm font-serif tracking-wide text-luxury-brown bg-luxury-beige hover:bg-luxury-sand transition-colors border border-luxury-sand"
                >
                  Clear Filters
                </button>
              )}
          ...
          <div className="md:col-span-3">
            {error && (
              <div className="bg-red-50 border border-red-200 text-red-700 px-6 py-4 mb-10">
                {error}
              </div>
            )}
            ...
            {loading ? (
              ...
              <div className="text-center py-20">
                ...
                <button
                  ...
                  className="px-8 py-4 bg-luxury-gold text-white font-serif tracking-wider uppercase hover:bg-luxury-darkGold transition-all"
                >
                  Reset Filters
                </button>
              </div>
                ...
                {totalPages > 1 && (
                  <div className="flex items-center justify-center gap-3 py-12 border-t border-luxury-sand">
                    <button
                      ...
                      className="px-5 py-3 border border-luxury-sand bg-white disabled:opacity-40 disabled:cursor-not-allowed hover:border-luxury-gold transition-colors text-luxury-brown font-serif"
                    >
                      Previous
                    </button>
                        ...
                        <button
                          ...
                          className={`px-5 py-3 font-serif transition-colors ${
                            isActive
                              ...
                              : 'border border-luxury-sand bg-white hover:border-luxury-gold text-luxury-brown'
                          }`}
                        >
                          {pageNum}
                        </button>
